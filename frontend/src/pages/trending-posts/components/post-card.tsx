...
export const PostCard = ({ post, expanded, onClick, onClose }: PostCardProps) => {
    ...
    >
      <div className="p-6">
        ...
        <div className="mb-4">
          ...
          {post.media && <img src={post.media} alt="Post media" className="mt-4 rounded-md max-h-80 object-cover" />}
        </div>
      ...
      {expanded && (
        <div className="border-t dark:border-slate-700 p-6">
